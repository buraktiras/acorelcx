 ...
 */
package nl.hybris.acorelcx.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AcorelcxFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AcorelcxFulfilmentProcessConstants.PARENT_PROCESS);
