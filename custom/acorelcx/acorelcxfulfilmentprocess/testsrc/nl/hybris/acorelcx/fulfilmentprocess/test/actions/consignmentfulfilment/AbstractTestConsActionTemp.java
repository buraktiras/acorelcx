 ...
 */
package nl.hybris.acorelcx.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, AcorelcxFulfilmentProcessConstants.PARENT_PROCESS);
