...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/acorelcxstorefront/electronics/en",
						"https://electronics.local:9002/acorelcxstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/acorelcxstorefront/electronics/en",
						"https://electronics.local:9002/acorelcxstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/acorelcxstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/acorelcxstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/acorelcxstorefront/electronics/en",
						"https://electronics.local:9002/acorelcxstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/acorelcxstorefront",
						"https://electronics.local:9002/acorelcxstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/acorelcxstorefront",
						"https://electronics.local:9002/acorelcxstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/acorelcxstorefront/electronics/en",
						"https://electronics.local:9002/acorelcxstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
