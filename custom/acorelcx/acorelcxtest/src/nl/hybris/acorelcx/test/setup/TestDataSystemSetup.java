 ...
 */
package nl.hybris.acorelcx.test.setup;
...
import nl.hybris.acorelcx.test.constants.AcorelcxTestConstants;
import nl.hybris.acorelcx.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AcorelcxTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/acorelcxtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/acorelcxtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/acorelcxtest/import/cstickets.impex");
			...
			importImpexFile(context, "/acorelcxtest/import/csquotes.impex");
		}
	}
}
